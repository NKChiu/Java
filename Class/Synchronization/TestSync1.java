...
public class TestSync1 {
	...
	public static void main(String args[]) {
		...
		Account1 account = new Account1(out);  //account is the key to come in Synchronized
		
		//Account1 account2 = new Account1(out); //test1
		
		DepositThread1 first, second;
		first = new DepositThread1(account, 1000, "#1");
		second = new DepositThread1(account, 1000, "\t\t\t\t#2");
		
		//second = new DepositThread1(account2, 1000, "\t\t\t\t#2"); //test1
